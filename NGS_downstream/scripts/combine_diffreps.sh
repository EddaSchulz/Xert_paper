#!/bin/bash
# Script to prepare differential H3K9me3 BED files for visualization in UCSC genome browser

input_dir=$1 # Contains BED files that were generated using /NGS_downstream/diffreps.sh and /NGS_downstream/diffreps_consensus.sh
output_dir=$2
...
do
  ...
  awk 'BEGIN {OFS="\t"}; {if($12>0) $9="255,000,000"; else $9="000,000,255"; print $0;}' $f\_diff.bed > $f\_pre_rgb.bed
