#!/bin/bash
# Calls peaks for unpaired ChIP-seq data from Li et al., 2019 (GSE109524)

work_dir=$1
bam_dir=$2 # Contains BAM files generated using /NGS_alignment/Li_ChIPseq_align.sh
...
do
  ...
  macs2 callpeak -t ${bam_dir}*_r1_dedup.bam -c ${bam_dir}Input_${cond}_r1_dedup.bam -g hs -q 0.05 -n $f\_r1 --outdir ${peaks_dir}
  macs2 callpeak -t ${bam_dir}*_r2_dedup.bam -c ${bam_dir}Input_${cond}_r2_dedup.bam -g hs -q 0.05 -n $f\_r2 --outdir ${peaks_dir}
