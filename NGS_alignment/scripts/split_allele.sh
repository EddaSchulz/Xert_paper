...
FILE=$(basename $BAM)
NAME=${FILE%.bam}
BAMF1=${TARGET_D}/${NAME}_minus1.bam
BAMF2=${TARGET_D}/${NAME}_minus2.bam
BAMF=${TARGET_D}/${NAME}_minus.bam
BAMR1=${TARGET_D}/${NAME}_plus1.bam
BAMR2=${TARGET_D}/${NAME}_plus2.bam
BAMR=${TARGET_D}/${NAME}_plus.bam
