#!/bin/bash
# Calls peaks for ATAC-seq data

work_dir=$1
bam_dir=$2 # Contains BAM files generated using /NGS_alignment/ATACseq_align.sh
...
do
  ...
  macs2 callpeak -t ${bam_dir}*_r1_dedup.bam -f BAMPE -g mm -q 0.05 -n $f\_r1 --outdir ${peaks_dir}
  macs2 callpeak -t ${bam_dir}*_r2_dedup.bam -f BAMPE -g mm -q 0.05 -n $f\_r2 --outdir ${peaks_dir}
